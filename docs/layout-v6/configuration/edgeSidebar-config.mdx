...
export function DemoPermanent() {
  return (
    <Root sx={{ minHeight: "20vh" }}>
      <EdgeSidebar
        className="border bg-green-50 p-2"
        sx={(theme) => ({
          ...applyEdgeSidebarStyles(theme, {
            config: {
...
**Required** `EdgeSidebarContent` component.
    ...
    <Root sx={{ minHeight: "25vh" }}>
      ...
      <Content className="flex justify-center items-center">
        <Button
          ...
          onClick={event => toggleEdgeSidebarCollapse({ event, sidebarId: 'persistent-fit' })}>Toggle Sidebar</Button>
      </Content>
    </Root>
  ...
  return (
    <Root sx={{ minHeight: "25vh" }}>
      ...
      <Content className="flex justify-center items-center">
        <Button
          className="CollapseTrigger"
          onClick={event => toggleEdgeSidebarCollapse({ event, sidebarId: 'persistent-none' })}>Toggle Sidebar</Button>
      </Content>
    </Root>
...
To toggle the sidebar, you should set the `width` to the config and use the `toggleTemporaryEdgeSidebar` function.
The toggle button should have class `EdgeSidebar-trigger` to display properly.
      ...
      <EdgeSidebarRight
        sx={(theme) => ({
          ...applyEdgeSidebarRightStyles(theme, {
            config: {
              xs: { variant: "temporary", width: "256px" },
              sm: { variant: "permanent", autoCollapse: 'sm', collapsedWidth: '80px', expandOnHover: true },
            },
          }),
        })}
      >
        ...
        <EdgeSidebarContent>
          <div className="p-2 bg-green-50 border h-full">Right EdgeSidebar</div>
        </EdgeSidebarContent>
      </EdgeSidebarRight>
      <Content className="flex justify-center items-center">
        <Button
