...
```jsx
import { getContent, getHeader } from "path/to/layout-core";
...
```jsx
import { Content, Header } from "path/to/layout-core";
```
...
```jsx
import { getSidebarTriggger } from "path/to/layout-core";
...
```jsx
import { EdgeTrigger } from "path/to/layout-core";
...
```jsx
import Layout from 'path/to/layout-core';
