...
const ContainedLabelTabs = Object.assign({}, ContainedTabs);
...
ContainedLabelTabs.info = {
  name: 'Contained Tabs (Label)',
...
export default ContainedLabelTabs;
