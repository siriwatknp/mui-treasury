...
```bash
yarn add @material-ui/core@next @material-ui/icons@next @emotion/styled @emotion/react @mui-treasury/layout@next @mui-treasury/mockup@next
```
...
import { Root, Header, EdgeSidebar } from "@mui-treasury/layout";
