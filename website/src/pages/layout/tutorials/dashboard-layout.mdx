...
![image](https://user-images.githubusercontent.com/18292247/80662164-cdd41580-8aba-11ea-8fdf-98779c5870ab.png)
...
```js
// highlight-next-line
const { Root, Header, DrawerSidebar, SidebarTrigger } = getLayoutComponents(
  styled
);
