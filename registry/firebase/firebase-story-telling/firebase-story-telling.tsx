...
2. Create relevant images that illustrate key moments, scenes, or steps
3. Interleave images naturally with the text as you progress through the narrative
4. Maintain visual consistency in style throughout the story
Always aim to create an immersive, illustrated experience.`,
              generationConfig: {
                responseModalities: [
