...
export const registryOrder: Record<string, string[]> = {
  ...
  'primitive/accordion': ['accordion-mui-treasury'],
  'primitive/alert': ['alert-mui-treasury'],
  'primitive/app-bar': ['app-bar-mui-treasury'],
  'primitive/autocomplete': ['autocomplete-mui-treasury'],
  'primitive/avatar': ['avatar-mui-treasury'],
  'primitive/badge': ['badge-mui-treasury'],
  'primitive/breadcrumbs': ['breadcrumbs-mui-treasury'],
  'primitive/button': ['button-mui-treasury'],
  'primitive/button-group': ['button-group-mui-treasury'],
  'primitive/checkbox': ['checkbox-mui-treasury'],
  'primitive/chip': ['chip-mui-treasury'],
  'primitive/dialog': ['dialog-mui-treasury'],
  'primitive/list': ['list-mui-treasury'],
  'primitive/menu': ['menu-mui-treasury'],
  'primitive/pagination': ['pagination-mui-treasury'],
  'primitive/progress': ['progress-mui-treasury'],
  'primitive/radio': ['radio-mui-treasury'],
  'primitive/rating': ['rating-mui-treasury'],
  'primitive/select': ['select-mui-treasury'],
  'primitive/slider': ['slider-mui-treasury'],
  'primitive/snackbar': ['snackbar-mui-treasury'],
  'primitive/stepper': ['stepper-mui-treasury'],
  'primitive/switch': ['switch-mui-treasury'],
  'primitive/table': ['table-mui-treasury'],
  'primitive/tabs': ['tabs-mui-treasury'],
  'primitive/text-field': ['text-field-mui-treasury'],
  'primitive/toggle-button': ['toggle-button-mui-treasury'],
  'primitive/tooltip': ['tooltip-mui-treasury'],
  'primitive/typography': ['typography-mui-treasury'],
};
