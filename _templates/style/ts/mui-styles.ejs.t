...
unless_exists: true
---
<% type = h.changeCase.pascal(name) + h.changeCase.pascal(category) %><% fileName = name + h.changeCase.pascal(category) %>import { createStyles } from '@material-ui/core/styles';
