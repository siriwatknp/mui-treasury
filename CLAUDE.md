...
- Run `pnpm --filter e2e exec playwright test --project=visual -g <registry_name> --update-snapshots && pnpm sync:og` (see `.claude/rules/visual-regression.md` for interactive setups)
