...
export type LineNavigationMenuClassKey = keyof ReturnType<typeof lineNavigationMenuStyles>

const itemHorzPadding = 2
const lineNavigationMenuStyles = ({ spacing, palette }: Theme) => createStyles({
  menu: {
    display: 'flex',
    overflow: 'auto',
  },
